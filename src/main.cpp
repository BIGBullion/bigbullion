...
uint256 hashGenesisBlock("0x00000000b66503d064dea6f8c00ba8c77a60089f8d8a8d551a82a5f0251f8699");
...
const string strMessageMagic = "BIGBullion Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 147000 blocks, which will occur approximately every 4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000b66503d064dea6f8c00ba8c77a60089f8d8a8d551a82a5f0251f8699");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1403602856;
        block.nBits    = 486604799;
        block.nNonce   = 356336999;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BIGBullionMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BIGBullionMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BIGBullionMiner started\n");
    ...
    try { loop {
        ...
        printf("Running BIGBullionMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BIGBullionMiner terminated\n");
        throw;
    }
}
